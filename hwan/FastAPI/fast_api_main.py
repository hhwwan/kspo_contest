...
# SDI
app.include_router(region_sdi_router, prefix="/sdi", tags=["지역별 SDI"])
app.include_router(city_size_sdi_router, prefix="/sdi", tags=["도시규모별 SDI"])
app.include_router(gender_age_sdi_router, prefix="/sdi", tags=["성별연령별 SDI"])

# PDI
app.include_router(region_pdi_router, prefix="/pdi", tags=["지역별 PDI"])
app.include_router(city_size_pdi_router, prefix="/pdi", tags=["도시규모별 PDI"])
app.include_router(gender_age_pdi_router, prefix="/pdi", tags=["성별연령별 PDI"])